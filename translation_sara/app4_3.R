  ...
  prep.hr.fun <- reactive({
   ...
   # output$tab2_content <- renderUI({
    #  if (input$selected_language == "en") {
     #   rmarkdown::render("output_report_eng.Rmd", "html_document")
      #  includeHTML("output_report_eng.html")
        #includeHTML("test1.html")
      #} else if (input$selected_language == "ind") {
        #rmarkdown::render("output_report_ind.Rmd", "html_document")
    ...
    output$downloadBtn <- downloadHandler(
      ...
      content = function(file) {
        if (input$selected_language == "en") {
          ...
          rmarkdown::render("/Users/sara/Desktop/STARmeds stuff/shiny/output_report_eng.Rmd", output_file = file)
        } 
        else if (input$selected_language  == "ind") {
          # Create the R Markdown content
          rmarkdown::render("/Users/sara/Desktop/STARmeds stuff/shiny/output_report_ind.Rmd", output_file = file)
        } 
      }
    )
